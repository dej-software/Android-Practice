...
//                        e.printStackTrace();
                ...
                protected void onProgressUpdate(String... values) {
                    ...
                    // 服务器发回连接信息
                    if (flag == ClientUtil.DATA_FLAG_CONNECT) {
                    ...
                    // 服务器发来其他客户端共享的位置信息
                    if (flag == ClientUtil.DATA_FLAG_MAP) {
                        if (mapCallBack != null) {
     ...
     * 处理用户名设置的回调
     */
    private SocketUserCallBack userCallBack = null;

    public SocketUserCallBack getUserCallBack() {
        return userCallBack;
    }

    public void setUserCallBack(SocketUserCallBack userCallBack) {
        this.userCallBack = userCallBack;
    }

    public interface SocketUserCallBack {
        void onSocketMsgCallback(String msg);
    }
